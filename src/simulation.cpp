...
Simulation::Simulation(int window_width, int window_height, int ball_count)
    : window(sf::VideoMode(window_width, window_height), "Ball Simulation"),
      main_circle(window_width < window_height
                      ? window_width / 3.0
                      : window_height /
                            3.0) // min(window_width, window_height) / 3.0)
{
    ...
    main_circle.setPosition(window_width / 2.0 - main_circle.getRadius(),
                            window_height / 2.0 - main_circle.getRadius());
